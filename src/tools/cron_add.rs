...
impl Tool for CronAddTool {
    ...
    fn description(&self) -> &str {
        "Create a scheduled cron job (shell or agent) with cron/at/every schedules. \
         ...
         To deliver output to a channel (Discord, Telegram, Slack, Mattermost, QQ, Lark, Feishu, Email, Matrix), set \
            ...
            "properties": {
                ...
                "delivery": {
                    ...
                    "properties": {
                        ...
                        "channel": { "type": "string", "enum": ["telegram", "discord", "slack", "mattermost", "qq", "lark", "feishu", "email", "matrix"], "description": "Channel type to deliver to" },
